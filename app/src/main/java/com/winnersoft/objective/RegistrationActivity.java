...
public class RegistrationActivity extends AppCompatActivity {
    ...
    MaterialSpinner spnCountry, spnState, spnDistrict, spnBloodGrp, spnQualification, spnOrganization;
    String countryName = "", stateName = "", districtName = "", blood_group = "", organization = "";
    int countryId = 0, stateId = 0, districtId = 0, organizationId = 0;
    ...
    final ArrayList<HashMap<String, String>> arraymapOrganization = new ArrayList<>();
    ArrayList<String> nameListOrganization = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnOrganization = findViewById(R.id.spn_organization);
            ...
            JsonObjectRequest jsonArrayRequest = new JsonObjectRequest(Request.Method.GET, jsonurl, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if (response.length() > 0) {
                        getAllState();
                        try {
                            JSONArray jsonArray = response.getJSONArray("organization");
                            for (int i = 0; i < jsonArray.length(); i++) {
                                JSONObject obj = jsonArray.getJSONObject(i);
                                HashMap<String, String> hashMap = new HashMap<>();
                                hashMap.put("id", obj.getString("id"));
//                                hashMap.put("orgOwnner", obj.getString("orgOwnner"));
//                                hashMap.put("orgRegId", obj.getString("orgRegId"));
//                                hashMap.put("orgAddress", obj.getString("orgAddress"));
//                                hashMap.put("orgContactNo", obj.getString("orgContactNo"));
//                                hashMap.put("orgStartedDate", obj.getString("orgStartedDate"));
                                hashMap.put("orgName", obj.getString("orgName"));
                                String name = obj.getString("orgName");
                                nameListOrganization.add(name);

                                arraymapOrganization.add(hashMap);
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

                        ArrayAdapter<String> stringArrayAdapter2 = new ArrayAdapter<>(RegistrationActivity.this, android.R.layout.simple_spinner_item, nameListOrganization);
                        spnOrganization.setAdapter(stringArrayAdapter2);
                        ...
                        spnOrganization.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                if (!valuename.equals(getResources().getString(R.string.selOrganization))) {
                                    organizationId = Integer.parseInt(arraymapOrganization.get(position).get("id"));
                                    organization = (arraymapOrganization.get(position).get("orgName"));
                                } else {
                                    organizationId = 0;
                                    organization = "";
                                }
...
//      selectedItemOfMySpinner = spnOrganization.getSelectedItemPosition();
//        actualPositionOfMySpinner = (String) spnOrganization.getItemAtPosition(selectedItemOfMySpinner);
//
//        if (actualPositionOfMySpinner.equalsIgnoreCase("null")) {
//            setSpinnerError(spnOrganization,getString(R.string.plsSelectOrganization));
//        }

//        int selectedItemOfMySpinners = spnState.getSelectedItemPosition();
//        String actualPositionOfMySpinners = (String) spnState.getItemAtPosition(selectedItemOfMySpinners);
//
//        if (actualPositionOfMySpinners.equalsIgnoreCase("null")) {
//            setSpinnerError(spnState,getString(R.string.plsSelectState));
//        }
...
//        qualification=edtQualification.getText().toString();
        ...
        if (!commonCode.isValidString(RegistrationActivity.this, organization) || !commonCode.isValidString(RegistrationActivity.this, address) || !commonCode.isValidString(RegistrationActivity.this, stateName) || !commonCode.isValidString(RegistrationActivity.this, districtName)|| !commonCode.isValidString(RegistrationActivity.this, blood_group) || !edtEmerNumber.getText().toString().trim().matches("^[6789]\\d{9}$") || !commonCode.isValidMobileNo(RegistrationActivity.this, emrMobileNo) || !commonCode.isValidString(RegistrationActivity.this, qualification) || !edtMobileNo.getText().toString().trim().matches("^[6789]\\d{9}$") || !commonCode.isValidMobileNo(RegistrationActivity.this, mobileNo) || !edtEmail.getText().toString().trim().matches("^(([^<>()\\[\\]\\\\.,;:\\s@\"]+(\\.[^<>()\\[\\]\\\\.,;:\\s@\"]+)*)|(\".+\"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$") || edtEmail.getText().toString().trim().equals("") || rbValue.equals("") || dateOfAdmission.equals("") || dateOfBirth.equals("") || !commonCode.isValidString(RegistrationActivity.this, motherName) || !commonCode.isValidString(RegistrationActivity.this, firstName) || !commonCode.isValidString(RegistrationActivity.this, middleName) || !commonCode.isValidString(RegistrationActivity.this, lastName)) {
            ...
            if (!commonCode.isValidString(RegistrationActivity.this, middleName)) {
                edtMName.setError(getResources().getString(R.string.plsEnterMiddleName));
                edtMName.requestFocus();
            }
            if (!commonCode.isValidString(RegistrationActivity.this, lastName)) {
                edtLName.setError(getResources().getString(R.string.plsEnterLastName));
                edtLName.requestFocus();
            }
            if (!commonCode.isValidString(RegistrationActivity.this, motherName)) {
            ...
            if (dateOfAdmission.equals("")) {
                ...
                edtDateofAdmission.setError(null);
            }
            if (rbValue.equals("")) {
...
//        }
            ...
            if (!commonCode.isValidMobileNo(RegistrationActivity.this, mobileNo)) {
            ...
            if (!commonCode.isValidString(RegistrationActivity.this, qualification)) {
                spnQualification.setError(getResources().getString(R.string.plsSelectQualification));
                spnQualification.requestFocus();
            }
            if (!commonCode.isValidMobileNo(RegistrationActivity.this, emrMobileNo)) {
...
//            spnOrganization.setError(getResources().getString(R.string.plsSelectOrganization));
//            spnOrganization.requestFocus();
//        } else if (!commonCode.isValidString(RegistrationActivity.this, firstName)) {
//            edtFName.setError(getResources().getString(R.string.plsEnterFirstName));
//            edtFName.requestFocus();
...
//            edtLName.setError(getResources().getString(R.string.plsEnterLastName));
//            edtLName.requestFocus();
//        } else if (!commonCode.isValidString(RegistrationActivity.this, motherName)) {
//            edtMotherName.setError(getResources().getString(R.string.plsEnterMotherName));
//            edtMotherName.requestFocus();
...
//            edtMobileNo.setError(getResources().getString(R.string.plsEnterValidMobNo));
//            edtMobileNo.requestFocus();
//        } else if (!commonCode.isValidString(RegistrationActivity.this, qualification)) {
//            spnQualification.setError(getResources().getString(R.string.plsSelectQualification));
//            spnQualification.requestFocus();
//        } else if (!commonCode.isValidMobileNo(RegistrationActivity.this, emrMobileNo)) {
//            edtEmerNumber.setError(getResources().getString(R.string.plsEnterMobNo));
//            edtEmerNumber.requestFocus();
//        } else if (!edtEmerNumber.getText().toString().trim().matches("^[6789]\\d{9}$")) {
//            edtEmerNumber.setError(getResources().getString(R.string.plsEnterValidMobNo));
//            edtEmerNumber.requestFocus();
//        } else if (!commonCode.isValidString(RegistrationActivity.this, blood_group)) {
//            spnBloodGrp.setError(getResources().getString(R.string.plsSelectBloodGrp));
//            spnBloodGrp.requestFocus();
    ...
    private void register() {
        if (commonCode.checkConnection(RegistrationActivity.this)) {
            ...
            try {
                ...
                adminObj.put("id", organizationId);
                jsonParams.put("organization", adminObj);
...
//                            Toast.makeText(getApplicationContext(), getResources().getString(R.string.registeredSuccessfully), Toast.LENGTH_LONG).show();
                            regSuccessPopup();
                        } else if (message.equals("Student already exist")) {
//                            mobNoAlreadyPopup();
