    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnQualification.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!qual.equalsIgnoreCase("Select qualification")){
                    qualification=qual;
                }
            }
        ...
        spnBloodGrp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!blood_group1.equals("Select blood group")) {
        ...
        edtDob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(
                        UserRegistration.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//        edtQualification=findViewById(R.id.edt_qualification);
    ...
    private void getAllState() {
        ...
        nameListState.clear();
        countryId = 1269750;
        if (commonCode.checkConnection(UserRegistration.this)) {
            ...
            JsonObjectRequest jsonArrayRequest = new JsonObjectRequest(Request.Method.GET, jsonurl, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    if (response.length() > 0) {
                        ...
                        ArrayAdapter<String> stringArrayAdapter2 = new ArrayAdapter<>(UserRegistration.this, android.R.layout.simple_spinner_item, nameListState);
...
//                        commonCode.AlertDialog_Pbtn(RegistrationActivity.this, getResources().getString(R.string.notFound), getResources().getString(R.string.complaintsNotFound), getResources().getString(R.string.ok));
            ...
            commonCode.AlertDialog_Pbtn(UserRegistration.this, getResources().getString(R.string.noInternetConnection), getResources().getString(R.string.plsConnectToInternet), getResources().getString(R.string.ok));
        }
    }
                ...
                JsonObjectRequest jsonArrayRequest = new JsonObjectRequest(Request.Method.GET, jsonurl, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (response.length() > 0) {
                            ...
                            ArrayAdapter<String> stringArrayAdapter2 = new ArrayAdapter<>(UserRegistration.this, android.R.layout.simple_spinner_item, nameListDistrict);
...
//        qualification=edtQualification.getText().toString();
        ...
        if (!commonCode.isValidString(UserRegistration.this, firstName)) {
            edtFName.setError(getResources().getString(R.string.plsEnterFirstName));
            edtFName.requestFocus();
        } else if (!commonCode.isValidString(UserRegistration.this, middleName)) {
            edtMName.setError(getResources().getString(R.string.plsEnterMiddleName));
            edtMName.requestFocus();
        } else if (!commonCode.isValidString(UserRegistration.this, lastName)) {
            edtLName.setError(getResources().getString(R.string.plsEnterLastName));
            edtLName.requestFocus();
        }else if (!commonCode.isValidString(UserRegistration.this, motherName)) {
...
//            edtDateofAdmission.setFocusableInTouchMode(true);
            ...
            edtEmail.requestFocus();
        } else if (!commonCode.isValidMobileNo(UserRegistration.this, mobileNo)) {
            edtMobileNo.setError(getResources().getString(R.string.plsEnterMobNo));
            edtMobileNo.requestFocus();
        } else if (!commonCode.isValidString(UserRegistration.this, qualification)) {
            spnQualification.setError(getResources().getString(R.string.plsSelectState));
            spnQualification.requestFocus();
        }else if (!commonCode.isValidMobileNo(UserRegistration.this, emrMobileNo)) {
            edtEmerNumber.setError(getResources().getString(R.string.plsEnterMobNo));
            edtEmerNumber.requestFocus();
        }else if (!commonCode.isValidString(UserRegistration.this, blood_group)) {
            spnBloodGrp.setError(getResources().getString(R.string.plsSelectState));
            spnBloodGrp.requestFocus();
        }else if (!commonCode.isValidString(UserRegistration.this, stateName)) {
            spnState.setError(getResources().getString(R.string.plsSelectState));
            spnState.requestFocus();
        } else if (!commonCode.isValidString(UserRegistration.this, districtName)) {
            spnDistrict.setError(getResources().getString(R.string.plsSelectDistrict));
            spnDistrict.requestFocus();
        }else if (!commonCode.isValidString(UserRegistration.this, address)) {
    ...
    private void register() {
        if (commonCode.checkConnection(UserRegistration.this)) {
            ...
            try {
                ...
                jsonParams.put("district", districtName);
