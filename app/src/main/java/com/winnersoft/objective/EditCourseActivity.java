...
public class EditCourseActivity extends AppCompatActivity {
    ...
    String courseCode = "", courseName = "", courseDesc = "", courseDuration = "", jsonurl = "", courseFees = "", id;
    //    Double courseFees;
    Button btnUpdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.editCourse));
...
//        courseCode = getBundle.getString("courseCode");
//        courseName = getBundle.getString("courseName");
//        courseDesc = getBundle.getString("courseDesc");
//        courseDuration = getBundle.getString("duration");
//        courseFees = getBundle.getString("fees");
        id = getBundle.getString("id");

//        courseFees= String.valueOf(getBundle.getDouble("fees"));
...
//        edtCourseDescription.setText(courseDesc);
//        if (courseDuration.contains("hr")){
//            coursedur=courseDuration.replace("hr","");
//        }
//        edtCourseDuration.setText(coursedur);
//        edtCourseFees.setText(courseFees);
    ...
    private void getCourseById() {
        if (commonCode.checkConnection(getApplicationContext().getApplicationContext())) {
            jsonurl = urllink.url + "Course/getById/"+id ;
            RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext().getApplicationContext());
            progressDialog = new ProgressDialog(EditCourseActivity.this);
                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                courseCode = response.getString("courseCode");
                                courseDesc = response.getString("courseDesc");
                                courseName = response.getString("courseName");
                                courseDuration = response.getString("duration");
                                courseFees = response.getString("fees");
            ...
            commonCode.AlertDialog_Pbtn(EditCourseActivity.this, getResources().getString(R.string.noInternetConnection), getResources().getString(R.string.plsConnectToInternet), getResources().getString(R.string.ok));
        }
    }


    private void updateCourseValidation() {
        ...
        if (!commonCode.isValidString(EditCourseActivity.this, courseFees)||!commonCode.isValidString(EditCourseActivity.this, courseDuration)||!commonCode.isValidString(EditCourseActivity.this, courseDesc)||!commonCode.isValidString(EditCourseActivity.this, courseCode)||!commonCode.isValidString(EditCourseActivity.this, courseName)){
            if (!commonCode.isValidString(EditCourseActivity.this, courseCode)) {
                edtCourseCode.setError(getResources().getString(R.string.plsEnterCourseCode));
                edtCourseCode.requestFocus();
            } else if (!commonCode.isValidString(EditCourseActivity.this, courseName)) {
                edtCourseName.setError(getResources().getString(R.string.plsEnterCourseName));
                edtCourseName.requestFocus();
            } else if (!commonCode.isValidString(EditCourseActivity.this, courseDesc)) {
                edtCourseDescription.setError(getResources().getString(R.string.plsEnterCourseDesc));
                edtCourseDescription.requestFocus();
            } else if (!commonCode.isValidString(EditCourseActivity.this, courseDuration)) {
                edtCourseDuration.setError(getResources().getString(R.string.plsEnterCourseDuration));
                edtCourseDuration.requestFocus();
            }
//        else if (courseFees.equals("")||courseFees.equals(null)){
//            edtCourseFees.setError(getResources().getString(R.string.plsEnterCourseFees));
//            edtCourseFees.requestFocus();
//        }
            else if (!commonCode.isValidString(EditCourseActivity.this, courseFees)) {
                edtCourseFees.setError(getResources().getString(R.string.plsEnterCourseFees));
                edtCourseFees.requestFocus();
            }
        }else{
            jsonurl = urllink.url + "Course/update/" + id;
...
//        }
    ...
    private void updateCourse() {
        if (commonCode.checkConnection(EditCourseActivity.this)) {
            progressDialog = new ProgressDialog(EditCourseActivity.this);
            progressDialog.setMessage(getResources().getString(R.string.loading));
            progressDialog.show();
