...
public class ExamControllersList extends AppCompatActivity implements ItemClickListener {
    String SecurityToken, userName, userRole, userId;
    private SharedPreferences sharedPreferences;
    private RecyclerView rvExamControllers;
    private Button btnAddExamController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exam_controllers_list);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle(getResources().getString(R.string.examControllerList));
        ...
        rvExamControllers=findViewById(R.id.rv_examcontrollers);
        btnAddExamController=findViewById(R.id.btn_add_examcontroller);

        btnAddExamController.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AddExamControllerActivity.class);
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!commonCode.isValidString(ExamControllersList.this, searchKey)) {
...
//                    getAllExamControllers();
    ...
    private void getAllExamControllers(){
//        jsonurl = urllink.url + "regVolunteer/getAll";
        jsonurl = urllink.url + "user/getUserByUserType1/3" ;
        arraymap.clear();
        if (commonCode.checkConnection(getApplicationContext())) {
            //        jsonurl = urllink.url + "regVolunteer/getAll";
            RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
            progressDialog = new ProgressDialog(ExamControllersList.this);
...
//                                hashMap.put("userTypeName", String.valueOf(userObj.getBoolean("inactive_deactivate")));
                        ...
                        commonCode.AlertDialog_Pbtn(ExamControllersList.this, getResources().getString(R.string.notFound), getResources().getString(R.string.examControllerNotFound), getResources().getString(R.string.ok));
                    }
                    showdata(arraymap);
                }
            ...
            commonCode.AlertDialog_Pbtn(ExamControllersList.this, getResources().getString(R.string.noInternetConnection), getResources().getString(R.string.plsConnectToInternet), getResources().getString(R.string.ok));
        }
    }
    ...
    private void showdata(ArrayList<HashMap<String, String>> arraymap) {
        ...
        rvExamControllers.setLayoutManager(mLayoutManager);
        rvExamControllers.setAdapter(madapter);
        rvExamControllers.setVisibility(View.VISIBLE);
...
//        super.onClick(view, position);
        ...
        bundle.putString("userTypeName", profileDetails.getRole());
        bundle.putString("first_name", profileDetails.getFirstname());
        bundle.putString("middle_name", profileDetails.getMiddlename());
        bundle.putString("last_name", profileDetails.getLastname());
        bundle.putString("m_name", profileDetails.getMotherName());
        ...
        bundle.putString("mobile", profileDetails.getMobileno());
        bundle.putString("email", profileDetails.getEmailid());
        bundle.putString("bloodGroup", profileDetails.getBloodGroup());
        bundle.putString("emergencyMobNo", profileDetails.getEmergencyMobile());
        bundle.putString("highestQualification", profileDetails.getQualification());
        bundle.putString("nationality", profileDetails.getCountry());
...
//        bundle.putString("image", profileDetails.getImageName());
    ...
    private void getAllSearchExamControllers() {
        jsonurl = urllink.url + "regVolunteer/getByVolutNameOrMobNo/" + searchKey;
        arraymap.clear();
        if (commonCode.checkConnection(ExamControllersList.this)) {
            RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
            progressDialog = new ProgressDialog(ExamControllersList.this);
            progressDialog.setMessage(getResources().getString(R.string.loading));
            progressDialog.show();
